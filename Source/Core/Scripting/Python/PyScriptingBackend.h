...
public:
  PyScriptingBackend(std::filesystem::path script_filepath, API::EventHub& event_hub, API::Gui& gui,
                     ...
                     API::WiiIRManip& wii_ir_manip, API::WiiAccelManip& wii_accel_manip,
  ...
  API::WiiAccelManip* GetWiiAccelManip();
  API::WiiMotionPlusManip* GetWiiMotionPlusManip();
  API::NunchuckButtonsManip* GetNunchuckButtonsManip();
  API::NunchuckAccelManip* GetNunchuckAccelManip();
...
private:
  ...
  API::WiiAccelManip& m_wii_accel_manip;
  API::WiiMotionPlusManip& m_wii_motion_plus_manip;
  API::NunchuckButtonsManip& m_nunchuck_buttons_manip;
  API::NunchuckAccelManip& m_nunchuck_accel_manip;

...
void HandleCoroutine(const Py::Object module, const Py::Object coro, const Py::Object asyncEventTuple)
{
  ...
  {
    ERROR_LOG_FMT(CORE, "A coroutine was yielded to the emulator that it cannot process. "
  ...
  {
    ERROR_LOG_FMT(CORE, "An unknown event was tried to be awaited: {}", event_name);
    return;
  }

...
static PyObject* SaveToSlot(PyObject* self, PyObject* args)
{
  ...
  State::Save(Core::System::GetInstance(), static_cast<int>(slot), true);
  Py_RETURN_NONE;
}
...
static PyObject* LoadFromSlot(PyObject* self, PyObject* args)
{
  ...
  State::Load(Core::System::GetInstance(), static_cast<int>(slot));
  Py_RETURN_NONE;
}
...
static PyObject* SaveToFile(PyObject* self, PyObject* args)
{
  ...
  State::SaveAs(Core::System::GetInstance(), std::string(filename), true);
  Py_RETURN_NONE;
}
...
static PyObject* SaveToBytes(PyObject* self, PyObject* args)
{
  ...
  PyObject* pybytes =
      PyBytes_FromStringAndSize(reinterpret_cast<const char*>(data), buffer.size());
  if (pybytes == nullptr)
  {
    ERROR_LOG_FMT(CORE, "Failed to turn buffer into python bytes object");
    return nullptr;
  }
  return pybytes;
}
